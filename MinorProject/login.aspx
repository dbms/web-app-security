<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="MinorProject.login" %>
                                        ...
                                        <div class="form d-flex align-items-center">
                                            <div class="content">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtemail" type="email" placeholder="Email" class="input-material" runat="server" required ValidationGroup="signup"></asp:TextBox>
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <asp:Button ID="btnsave" runat="server" ValidationGroup="signup" Text="Login" class="btn btn-success" OnClick="btnsave_Click" /><br />
                                                <br />
                                                <small>Already have an account ? </small>&nbsp;<a href="signup.aspx" class="signup">Signup</a>
                                                <br />
                                                <br />
