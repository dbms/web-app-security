        ...
        <div class="page-content d-flex align-items-stretch">
            <nav class="side-navbar fixed-left" style="background: #1a2226; color: #fff">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="active"><a href="xss.html"><i class="icon-grid"></i>Cross Side Scripting (XSS) </a></li>
                </ul>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div style="text-align: center">
                                            <button class="btn btn-success" type="submit">Feeback</button>
                                        </div>
                                        <br />
                                    </div>
                                </div>
                                        ...
                                        <div class="form d-flex align-items-center">
                                            <div class="content">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtfeedback" placeholder="Enter a Message" TextMode="MultiLine" Columns="50" Rows="6" runat="server" required ValidationGroup="signup" Style="padding: 10px"></asp:TextBox>
                                                </div>
                                                <div style="text-align:center">
                                                    <asp:Button ID="btnsave" runat="server" ValidationGroup="signup" Text="Send" class="btn btn-danger" OnClick="btnsave_Click"   />
                                                <br />
